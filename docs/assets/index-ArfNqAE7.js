...
\r
\r
`;function Mf(){return Yt.useEffect(()=>{const e="/",n=e.endsWith("/")?e:`${e}/`;window.__legacyBaseUrl=n.startsWith("/")?n:`/${n}`;const t=()=>{if(window.__legacyAppInitialized)return;window.__legacyAppInitialized=!0;const r=new Event("DOMContentLoaded");document.dispatchEvent(r)};if(window.__legacyScriptLoaded)setTimeout(t,0);else{const r=document.createElement("script");r.type="text/javascript",r.text=`${Nf}
