...
function viewImage(imageSrc, altText, imageArray = null, startIndex = 0) {
    ...
    if (imageArray && Array.isArray(imageArray)) {
        currentImageGallery = imageArray;
...
function createImageViewer(imageSrc, altText) {
    ...
    const navPrevHTML = hasMultipleImages ? `<button class="image-nav-arrow image-nav-prev" onclick="navigateImage(-1)" title="Previous (←)">‹</button>` : '';
    ...
    modal.innerHTML = `
        ...
        <button class="image-viewer-close" onclick="closeImageViewer(this)" title="Close (ESC)">×</button>
        ${navPrevHTML}
        ${navNextHTML}
        ${counterHTML}
        <div class="image-viewer-content">
            <img src="${imageSrc}" alt="${altText}" onload="centerImage(this)" />
        </div>
    `;
...
function createImageGallery(images, packageName) {
    ...
    images.forEach((img, index) => {
        galleryHtml += `
            <div class="gallery-item-thumb" onclick="viewImage('${img}', '${packageName} - Image ${index + 1}', ${JSON.stringify(images).replace(/"/g, '&quot;')}, ${index})">
        ...
        items: [
            {
                ...
                images: [
                    ...
                    "https://strdevajiteastus001.blob.core.windows.net/ajitem/resources/Decoration Packages/Basic/Decoration Package Basic 05.jpeg",
                    "https://strdevajiteastus001.blob.core.windows.net/ajitem/resources/Decoration Packages/Basic/Decoration Package Basic 06.jpeg",
                    "https://strdevajiteastus001.blob.core.windows.net/ajitem/resources/Decoration Packages/Basic/Decoration Package Basic 07.jpeg",
                    "https://strdevajiteastus001.blob.core.windows.net/ajitem/resources/Decoration Packages/Basic/Decoration Package Basic 08.jpeg"
                ]
            },
            {
                name: "Standard", 
                ...
                images: [
                    ...
                    "https://strdevajiteastus001.blob.core.windows.net/ajitem/resources/Decoration Packages/Standard/Decoration Package Standard 05.jpg",
                    "https://strdevajiteastus001.blob.core.windows.net/ajitem/resources/Decoration Packages/Standard/Decoration Package Standard 06.jpg",
                    "https://strdevajiteastus001.blob.core.windows.net/ajitem/resources/Decoration Packages/Standard/Decoration Package Standard 07.jpg",
                    "https://strdevajiteastus001.blob.core.windows.net/ajitem/resources/Decoration Packages/Standard/Decoration Package Standard 08.jpg",
                    "https://strdevajiteastus001.blob.core.windows.net/ajitem/resources/Decoration Packages/Standard/Decoration Package Standard 09.jpg",
                    "https://strdevajiteastus001.blob.core.windows.net/ajitem/resources/Decoration Packages/Standard/Decoration Package Standard 10.jpg",
                    "https://strdevajiteastus001.blob.core.windows.net/ajitem/resources/Decoration Packages/Standard/Decoration Package Standard 11.jpg",
                    "https://strdevajiteastus001.blob.core.windows.net/ajitem/resources/Decoration Packages/Standard/Decoration Package Standard 12.jpg",
                    "https://strdevajiteastus001.blob.core.windows.net/ajitem/resources/Decoration Packages/Standard/Decoration Package Standard 13.jpg",
                    "https://strdevajiteastus001.blob.core.windows.net/ajitem/resources/Decoration Packages/Standard/Decoration Package Standard 14.jpg"
                ]
            },
            {
                name: "Gold",
                ...
                images: [
                    ...
                    "https://strdevajiteastus001.blob.core.windows.net/ajitem/resources/Decoration Packages/Gold/Decoration Package Gold 05.jpg",
                    "https://strdevajiteastus001.blob.core.windows.net/ajitem/resources/Decoration Packages/Gold/Decoration Package Gold 06.jpg",
                    "https://strdevajiteastus001.blob.core.windows.net/ajitem/resources/Decoration Packages/Gold/Decoration Package Gold 07.jpg",
                    "https://strdevajiteastus001.blob.core.windows.net/ajitem/resources/Decoration Packages/Gold/Decoration Package Gold 08.jpg",
                    "https://strdevajiteastus001.blob.core.windows.net/ajitem/resources/Decoration Packages/Gold/Decoration Package Gold 09.jpg",
                    "https://strdevajiteastus001.blob.core.windows.net/ajitem/resources/Decoration Packages/Gold/Decoration Package Gold 10.jpg",
                    "https://strdevajiteastus001.blob.core.windows.net/ajitem/resources/Decoration Packages/Gold/Decoration Package Gold 11.jpg",
                    "https://strdevajiteastus001.blob.core.windows.net/ajitem/resources/Decoration Packages/Gold/Decoration Package Gold 12.jpg",
                    "https://strdevajiteastus001.blob.core.windows.net/ajitem/resources/Decoration Packages/Gold/Decoration Package Gold 13.jpg",
                    "https://strdevajiteastus001.blob.core.windows.net/ajitem/resources/Decoration Packages/Gold/Decoration Package Gold 14.jpg"
                ]
            },
            {
                name: "Premium",
            ...
            },
            {
                ...
                images: [
                    ...
                    "https://strdevajiteastus001.blob.core.windows.net/ajitem/resources/Decoration Packages/Platinum/Decoration Package Platinum 05.jpg",
                    "https://strdevajiteastus001.blob.core.windows.net/ajitem/resources/Decoration Packages/Platinum/Decoration Package Platinum 06.jpg",
                    "https://strdevajiteastus001.blob.core.windows.net/ajitem/resources/Decoration Packages/Platinum/Decoration Package Platinum 07.jpg",
                    "https://strdevajiteastus001.blob.core.windows.net/ajitem/resources/Decoration Packages/Platinum/Decoration Package Platinum 08.jpg",
                    "https://strdevajiteastus001.blob.core.windows.net/ajitem/resources/Decoration Packages/Platinum/Decoration Package Platinum 09.jpg",
                    "https://strdevajiteastus001.blob.core.windows.net/ajitem/resources/Decoration Packages/Platinum/Decoration Package Platinum 10.jpg"
                ]
            }
        ]
    },
        ...
        packageData.items.forEach((item, index) => {
            html += `
                <div style="background: var(--card-gradient); border-radius: 15px; padding: 15px; text-align: center; border: 2px solid var(--primary-color); box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
                    <div style="width: 100%; height: 150px; border-radius: 10px; overflow: hidden; margin-bottom: 15px; background: linear-gradient(135deg, var(--primary-color), var(--secondary-color)); display: flex; align-items: center; justify-content: center; cursor: pointer;" onclick="viewImage('${item.image}', '${item.name} Game Stall')">
                        <img src="${item.image}" alt="${item.name}" style="width: 100%; height: 100%; object-fit: cover;" onerror="this.parentNode.innerHTML='<div style=\\'color: white; font-size: 2rem;\\'>🎯</div>';">
                    </div>
